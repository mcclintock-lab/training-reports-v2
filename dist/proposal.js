...
ArrayHabitatTab = (function(_super) {
  ...
  ArrayHabitatTab.prototype.render = function() {
    var aquacultureAreas, context, fishingAreaData, fishingAreas, mooringData, moorings, noNetZones, noNetZonesData, row, sanctuaries, sanctuary, _i, _len;
    sanctuaries = this.getChildren(SANCTUARY_ID);
    if (sanctuaries.length) {
