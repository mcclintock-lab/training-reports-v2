...
ArrayHabitatTab = (function(_super) {
  ...
  ArrayHabitatTab.prototype.renderMarxanAnalysis = function() {
    var color, curr_proposal, curr_score, data, domain, e, el, get_proposal_html, height, hide_tooltip, histo, i, isVisible, labelSelect, margin, max_q, min_q, name, node, nodeId, nodeMap, pointSelect, prop_ids, proposals, q, quantile, quantile_desc, quantile_range, quantiles, rec, records, scenarioName, score_map, scores, scores_data, sdata, show_tooltip, svg, toc, tooltip, view, width, x, xAxis, y, yAxis, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1;
    ...
    if (window.d3) {
      ...
      for (_l = 0, _len3 = quantiles.length; _l < _len3; _l++) {
        quantile = quantiles[_l];
    ...
    get_proposal_html = function(data, proposals) {
      ...
      if (proposals.length === 1) {
        ...
        for (_m = 0, _len4 = proposals.length; _m < _len4; _m++) {
          p = proposals[_m];
